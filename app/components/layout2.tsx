      ...
      <div>
        ...
        <div className="flex pt-16 overflow-hidden bg-white">
          <aside
            ...
            className={
              show
                ? "fixed z-20 h-full top-0 left-0 pt-16 flex lg:flex lg:translate-x-0 flex-shrink-0 flex-col w-64 transform  translate-x-0 duration-75"
                : "fixed z-20 h-full top-0 left-0 pt-16 flex lg:flex lg:translate-x-0 flex-shrink-0 flex-col w-64 transform -translate-x-full duration-75"
            }
            aria-label="Sidebar"
